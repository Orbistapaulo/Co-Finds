                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (roleFromDB.equals(user_role)) {
                                Intent intent = new Intent(Help.this, chat_list.class);
                                intent.putExtra("user_name", profileUsername);
                                startActivity(intent);
                            } else {
                                Intent intent = new Intent(Help.this, Chat_room.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.home) {
                    ...
                    Intent intent1 = new Intent(Help.this, Main_home.class);
                    ...
                    Intent intent1 = new Intent(Help.this, profile.class);
                    intent1.putExtra("name", name);
                    intent1.putExtra("email", email);
                    intent1.putExtra("username", username);
                    intent1.putExtra("password", password);
